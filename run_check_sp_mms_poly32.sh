...
CASE_FILE="/home/jd/anabasis_v0/cases/simple_fullsp_mms_reference/polyhedral_32cube_sp_noanchor_prepenalty.case"
RUN_DIR="/home/jd/anabasis_v0/runs/simple_fullsp_mms_reference/polyhedral_32cube_sp_noanchor_prepenalty"
LOG_FILE="/home/jd/anabasis_v0/runs/simple_fullsp_mms_reference/polyhedral_32cube_sp_noanchor_prepenalty/run.log"
...
if [ ! -d /home/jd/Desktop/meshes/unitcube/polyhedral/32cube/constant/polyMesh ]; then
  echo "ERROR: missing mesh: /home/jd/Desktop/meshes/unitcube/polyhedral/32cube/constant/polyMesh"
  exit 1
fi
...
echo
echo "=== Running SP MMS polyhedral 32cube smoke test ==="
echo "Case: ${CASE_FILE}"
echo "Log : ${LOG_FILE}"
echo
...
log = Path("/home/jd/anabasis_v0/runs/simple_fullsp_mms_reference/polyhedral_32cube_sp_noanchor_prepenalty/run.log")
...
print()
print("=== SP MMS polyhedral 32cube summary ===")
print("log      =", log)
print("anchor   =", anchor)
