...
VelocityPatchBCSpec make_parabolic_box_inlet_bc(
  ...
  VelocityPatchBCSpec out;
  out.patchName = patchName;
  out.type = VelocityBCType::ParabolicBoxInlet;
  out.parabolicBoxH = H;
  out.parabolicBoxUmax = Umax;
  out.parabolicCoordA = coordA;
  out.parabolicCoordB = coordB;
  out.normalVectorMode = mode;
  return out;
}
...
VelocityPatchBCSpec make_parabolic_box_sine_inlet_bc(
  ...
  VelocityPatchBCSpec out;
  out.patchName = patchName;
  out.type = VelocityBCType::ParabolicBoxSineInlet;
  out.parabolicBoxH = H;
  out.parabolicBoxUmax = Umax;
  out.parabolicCoordA = coordA;
  out.parabolicCoordB = coordB;
  out.parabolicTimeScale = timeScale;
  out.normalVectorMode = mode;
  return out;
}
